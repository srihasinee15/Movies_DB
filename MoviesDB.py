...
cursor.execute('''INSERT INTO movies(id, Movie_Name, Lead_Actor, Lead_Actress, Director_Name,Year_Of_Release) VALUES(1,"Anbe Sivam","Kamal Hassan","Urvashi Rautela","J. D.–Kamal Hassan",2022)''')
...
cursor.execute('''INSERT INTO movies(id, Movie_Name, Lead_Actor, Lead_Actress, Director_Name,Year_Of_Release) VALUES(3,"Beast","Vijay","Pooja Hedge","Nelson",2022)''')
...
sqlite_select_query = """SELECT * from movies where Lead_Actor = 'Vijay'"""
cursor.execute(sqlite_select_query)
records = cursor.fetchall()
print(pd.DataFrame(records,columns = ["ID","Movie_Name","Lead_Actor","Lead_Actress","Director_Name","Year_Of_Release"]))
